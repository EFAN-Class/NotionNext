...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'EFAN International Education', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '英文入门课程、美加同步全科辅导、西日法德小语种、备考课程，欢迎关注 ', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://EFANClass.com', // 网站地址
  ...
  CONTACT_BILIBILI: process.env.NEXT_PUBLIC_CONTACT_BILIBILI || 'https://space.bilibili.com/29127299?spm_id_from=333.337.0.0', // B站主页
